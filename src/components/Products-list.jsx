      ...
      products: [
        {
          ...
          title: "5 Door – SCOS01",
          description:
            "Compact models designed for independent residents/villas ",
          imagesByColor: {
            Green: a1,
            Brown: a2,
            Black: a3,
      ...
      products: [
        {
          id: 4,
          description:
            "Models designed for large spaces such as educational institutes, Malls, Apartments and workspaces",
          title: "32 Door – SCAS01",
          imagesByColor: {
            Green: d1,
            Brown: d2,
            Black: d3,
      ...
      products: [
        {
          id: 3,
          description:
            "Models designed for maximum utility within limited spaces",
          title: "17 Door – SMS02",
          imagesByColor: {
            Green: c1,
            Brown: c2,
      ...
      products: [
        {
          id: 5,
          description:
            "This product is designed for medium-sized workspaces with moderate number of use cases",
          title: "24-Door Add-On Locker (SCS01)",
          imagesByColor: {
            Green: e1,
            Brown: e2,
            Black: e3,
                  ...
                  >
                    ...
                    <div className="product-info">
                      ...
                      <p className="para-text">
                        {p.description ||
                          "Premium quality locker with modern design and durable finish."}
                      </p>
                      ...
                      <button
                        className="quote-btn"
                        onClick={() => {
                          const phoneNumber = "7673927227";
                          const message = `- Product: ${
                            p.title
                          }\n- Description: ${
                            p.description ||
                            "Premium quality locker with modern design and durable finish."
                          }\n- Selected Color: ${activeColour}`;
