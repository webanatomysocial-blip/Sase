            ...
            <div className="mobile-about-home-container-for-carosule">
                ...
                <div className="mobile-about-home-container-for-carosule-inner-right">
                    <Swiper
                        ...
                        slidesPerView={1}
                        spaceBetween={20}
                        height={210}  // ← ADD THIS LINE
                        // pagination={{
                        //     clickable: true,
                        //     dynamicBullets: true,  // ← ADD THIS
                        // }}
                        modules={[Pagination]}
                        className="mySwiper1"
                    // REMOVE: style={{ height: '210px' }} 
                    >
