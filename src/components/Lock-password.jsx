...
const LockPassword = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(".down-arrow-password-img, .down-text-password-section", {
        color: "#ffffff",
      });
  ...
  return (
    <section ref={sectionRef} className="locker-section">
      <div className="down-arrow-password-section">
        <RxDoubleArrowDown className="down-arrow-password-img" />
      ...
      <div className="locker-container">
        ...
        <div className="locker-vid-container">
          <img src={img} alt="" />
          <div className="vid-locker-box"></div>
        </div>

        <div className="cta-in-the-locker-section">
          <div className="cta-in-the-locker-container">
            <p className="para-text-white">
              Experience the next generation of smart lockers with SASE.
              Designed for convenience, security, and seamless access, our
              lockers simplify storage and deliveries for businesses and
              individuals alike.
            </p>
          </div>
